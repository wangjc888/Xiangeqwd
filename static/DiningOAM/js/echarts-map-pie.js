    ...
    series : [
        {
            ...
            center: ['50%', '50%'],
            data:[
                {value:judgeCount.judge_meal[0], name:'一星'},
                {value:judgeCount.judge_meal[1], name:'二星'},
                {value:judgeCount.judge_meal[2], name:'三星'},
                {value:judgeCount.judge_meal[3], name:'四星'},
                {value:judgeCount.judge_meal[4], name:'五星'}
